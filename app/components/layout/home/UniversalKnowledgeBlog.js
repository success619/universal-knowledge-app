  ...
  return (
    <View style={styles.sloganHeaderContainer}>
      ...
      <Text style={styles.openBlogGuideLine1}>
        You think forward towards what you want to know more about, whatever it
        is, Universal knowledge is here to help you !!!
      </Text>
      <Text style={styles.openBlogGuideLine}>
        You have been bordering to know more about the universe, Welcome to your
        solution Point, Everything is broken down accordingly & respectively,
        Here(Below) is the run Down
      </Text>
      <ChemistryOfEarth />
    </View>
  );
